...
from loan_solvency_service.services.orchestration.SolvencyVerificationService import SolvencyVerificationService
...
def test_verify_solvency_explanations_content(test_db):
    ...
    assert "1000" in report.explanations.income_vs_expenses_explanation or "surplus" in report.explanations.income_vs_expenses_explanation.lower()
    ...
    assert "debt" in credit_history_lower or "5000" in report.explanations.credit_history_explanation
    assert "late" in credit_history_lower or "2" in report.explanations.credit_history_explanation
