...
def test_explain_excellent_credit_score():
    ...
    assert "excellent" in result.credit_score_explanation.lower() or "850" in result.credit_score_explanation
...
def test_explain_poor_credit_score():
    ...
    assert "poor" in result.credit_score_explanation.lower() or "300" in result.credit_score_explanation
...
def test_explain_negative_cash_flow():
    ...
    assert "negative" in result.income_vs_expenses_explanation.lower() or "exceed" in result.income_vs_expenses_explanation.lower()
